      ...
      <>
        <Flexbox flexDirection='column' minHeight='100vh'>
            ...
            <div className='fixed-top'>
              <nav className='navbar navbar-expand-lg navbar-dark mx-background-top-linear' style={{ backgroundColor: '#e3f2fd' }}>
                <div className='container'>
                  <a className='navbar-brand' href='index.html'><h6 className='g-color-white-opacity-0_8 g-font-size-13'> VỒ CÁ BU LA RI </h6></a>
          ...
          <Flexbox flexGrow={1}>
            ...
            <button type='button' class='btn btn-outline-info' href='/' onClick={() => this.initMockData()}>NEXT</button>
          </Flexbox>
        </Flexbox>
      </>
    )
